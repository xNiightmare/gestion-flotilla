...
public class UsuarioController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UsuarioUpdateDTO> actualizarUsuario(@PathVariable Long id, @Valid @RequestBody UsuarioUpdateDTO usuarioUpdateDTO){
        return ResponseEntity.ok(this.usuarioService.actualizarUsuario(id, usuarioUpdateDTO));
    }
